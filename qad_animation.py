...
json_data = 'qad_2026-01-06_22-24-18_data.jsonl'
# Replace with your JSONL dat file in qad_simulation_results folder
...
print(f"\nLoading trajectories from '{json_data}'\n")
